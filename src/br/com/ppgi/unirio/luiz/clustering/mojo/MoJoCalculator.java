package br.com.ppgi.unirio.luiz.clustering.mojo;
...
*/
     ...
     * max(mno(any_A,B)) * 100%
     */
    private double mojofmValue(Vector<Integer> number_of_B, long obj_number, long totalCost) {
    ...
    private long maxDistanceTo(Vector<Integer> number_of_B, long obj_number) {
        int group_number = 0;
