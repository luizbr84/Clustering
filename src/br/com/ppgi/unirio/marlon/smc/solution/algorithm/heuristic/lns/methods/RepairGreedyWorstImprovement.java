 ...
 */
public class RepairGreedyWorstImprovement extends ARepairSolution{

    public RepairGreedyWorstImprovement(LNSConfiguration config) {
        super("RGWI", config);
    }
    
    protected RepairGreedyWorstImprovement(String name, LNSConfiguration config) {
        super(name, config);
    }
